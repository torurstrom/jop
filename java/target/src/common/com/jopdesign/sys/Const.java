...
public class Const {
	...
	public static final int IO_LCK_STAT = IO_BASE+5;
	public static final int IO_LCK_REL = IO_BASE+6; // mirrors CPU id, write-only
	public static final int IO_UNLOCK = IO_LCK_REL;
	public static final int IO_LCK_REQ = IO_BASE+11;
	public static final int IO_LOCK = IO_LCK_REQ;
